...
module.exports.run = async ({ api, event, args, Users, Currencies }) => {
    ...
    api.getUserInfoV2(uid).then(async res => {
        ...
        const getImg = await this.getImages(`https://graph.facebook.com/${uid}/picture?height=1500&width=1500&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`);
