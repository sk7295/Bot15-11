    ...
    for (const nameModule of moduleList) {
        try {
            ...
            if (command.config.dependencies && typeof command.config.dependencies == 'object') {
                ...
                for (const packageName in command.config.dependencies) {
                    ...
                    try {
                        ...
                        logger('[ 𝗖𝗠𝗗 ] - Không tìm thấy package ' + packageName + ' hỗ trợ cho lệnh ' + command.config.name+ 'tiến hành cài đặt...', 'warn');
                        const insPack = {};
                ...
                logger('Đã tải thành công toàn bộ package cho lệnh' + command.config.name,"[ 𝗖𝗠𝗗 ] ");
            }
            if (command.config.envConfig && typeof command.config.envConfig == 'Object') try {
                ...
                logger('Loaded config' + ' ' + command.config.name);
            } catch (error) {
            ...
            logger('Loaded command ' + command.config.name + '!','[ 𝗖𝗠𝗗 ]');
        } catch (error) {
...
const unloadModule = function ({ moduleList, threadID, messageID }) {
    ...
    for (const nameModule of moduleList) {
        ...
        logger(`Unloaded command ${nameModule}!`,'[ 𝗖𝗠𝗗 ]');
    }
